...
function congruentialMixedMethod(seed, a, c, m, cases) {
	...
	alert('Paso la primer prueba de Hull Dobel')
	...
	alert('Paso la segunda prueba de Hull Dobel')
	...
	alert('Paso la tercer prueba de Hull Dobel')
	return congMethodGen(seed, a, c, m, cases)
}
...
/**
 * Calcula los primos relativos usando el algoritmo de Euclides
 * @param {*} a 
 * @param {*} b 
 */
